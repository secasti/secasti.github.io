...
I develop standalone web applications to make spatial data accessible and performant. 
* **Featured Project:** [Te Ara Hura Interactive Trail Map](https://secasti.github.io/te-ara-hura/) — Built using **MapLibre GL JS** and **OpenStreetMap** data to visualize complex trail networks with custom vector styling.

### 🔍 Data Integrity & Spatial QA/QC
With experience in **NEPA compliance** and hazardous tree management, I have a "Zero-Error" approach to geospatial datasets.
* **Expertise:** Auditing field-collected GPS data, managing biological buffers, and ensuring 100% scientific consistency in complex environmental layers.
